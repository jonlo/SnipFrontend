...
var $            = __webpack_require__(1)
  ...
  , $has         = __webpack_require__(8)
  , isObject     = __webpack_require__(2)
  , setSpecies   = __webpack_require__(34)
  , DESCRIPTORS  = __webpack_require__(10)
...
var $           = __webpack_require__(1)
  ...
  , fails       = __webpack_require__(6)
  , $trim       = __webpack_require__(33).trim
  , NUMBER      = 'Number'
...
$export($export.S, 'Math', {log1p: __webpack_require__(57)});
...
__webpack_require__(33)('trim', function($trim){
...
__webpack_require__(33)('trimLeft', function($trim){
...
// https://github.com/sebmarkbage/ecmascript-string-left-right-trim
__webpack_require__(33)('trimRight', function($trim){
...
// CONCATENATED MODULE: ./src/scripts/restClient/snippetApi.js
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(from, limit) {
  ...
  return function getSnippets(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();


// CONCATENATED MODULE: ./src/scripts/Navigators/snippetNav.js
...
function () {
  function SnippetNav() {
    _classCallCheck(this, SnippetNav);

    this.snippets = [];
    this.parentDiv = document.getElementById('snippets-holder');
  }

  _createClass(SnippetNav, [{
    key: "populate",
    value: function populate(_snippets) {
      var _this = this;
      ...
      _snippets.forEach(function (snippet, index) {
        ...
        _this.parentDiv.appendChild(snippetBox);

        snippetBox.addEventListener("click", function (e) {
          _this.showSnippet(e, index);
        });
      });
    }
  }, {
    key: "showSnippet",
    value: function showSnippet(e, i) {
...
function getSnippetsFromAPI() {
  return _getSnippetsFromAPI.apply(this, arguments);
}

function _getSnippetsFromAPI() {
  _getSnippetsFromAPI = scripts_asyncToGenerator(
  /*#__PURE__*/
